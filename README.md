...
```toml
[dependencies]
bitaxe-api = { git = "https://github.com/BNKRORG/bitaxe-api", tag = "<version>" }
```
...
If you are looking for a Kraken API client, please use https://github.com/w3ird-tech/bacli or similar library.
